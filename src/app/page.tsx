      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        ...
        {isIndexReady && !isBootstrapping && (
          <div className='w-full'>
            <h1 className='text-4xl font-bold text-center text-gray-900 mb-3'>Legal Document Search</h1>
              ...
              {results.map((result, index) => (
                ...
                >
                  <CardContent className='p-6'>
                    <h2 className='text-xl font-semibold mb-3 text-gray-900'>{result.metadata.title}</h2>
                    <blockquote className='relative p-4 mb-4 bg-gray-50 rounded-lg'>
                      <p className='text-gray-700 line-clamp-4 italic'>{sanitizeString(result.metadata.pageContent)}</p>
                    </blockquote>
                    <div className='space-y-2 text-sm text-gray-600'>
                      <div className='flex items-center'>
                        <span className='font-medium text-gray-900 w-20'>Topic:</span>
                        <span className='truncate'>{result.metadata.topic}</span>
                      </div>
                      <div className='flex items-center'>
                        <span className='font-medium text-gray-900 w-20'>Verdict:</span>
                        <span className='truncate'>{result.metadata.outcome}</span>
                      </div>
                      <div className='flex items-center'>
                        <span className='font-medium text-gray-900 w-20'>Date:</span>
