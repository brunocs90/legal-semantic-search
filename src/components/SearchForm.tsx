  ...
  return (
    <div className='w-full max-w-2xl mx-auto'>
      <form onSubmit={handleSubmit} className='relative w-full'>
        ...
        <button
          type='submit'
          className={`absolute top-1/2 transform -translate-y-1/2 -right-14 w-12 h-12 flex items-center justify-center bg-indigo-800 text-white rounded-full ${
            !query && 'opacity-50 bg-gray-600 cursor-not-allowed'
          }`}
          disabled={!query}
        >
          ➔
